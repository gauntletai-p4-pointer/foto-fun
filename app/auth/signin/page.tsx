      ...
      <div className="w-full max-w-md space-y-8 px-4">
        ...
        <div className="space-y-6">
          ...
          <div className="text-center space-y-2">
            <div className="mx-auto w-16 h-16 rounded-xl bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center">
              <span className="text-white font-bold text-2xl">F</span>
            </div>
            <h1 className="text-2xl font-semibold">Sign in to FotoFun</h1>
            <p className="text-foreground/60">
              Sign in with your Google account to continue
            </p>
          </div>

          {/* Plan info if coming from pricing */}
          {plan && (
